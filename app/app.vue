<template>
  <div class="min-h-screen">
    <div 
      class="min-h-screen rounded-xl bg-slate-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors pb-20"
    >
      <AppHeader :is-dark="isDarkMode" @toggle-theme="toggleTheme" @open-settings="showSettings = true" />

      <main class="max-w-4xl mx-auto px-4 py-6">
        <NuxtPage /> 
      </main>

      <BottomNav :current-page="currentRouteName" @change-page="navigateTo($event)" />
